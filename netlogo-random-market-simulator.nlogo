...
to-report valid-trade? [trade]
  ...
  report ([inv item-sent] of sender >= item-sent-amt) and
     ([inv item-received] of receiver >= item-received-amt)
end

to execute-trade [ trade ]
  let sender item 0 trade
  let receiver item 1 trade
  let item-sent item 2 trade
  let item-sent-amt item 3 trade
  ...
  let item-received-amt item 5 trade
  ask sender [
    mod-inventory item-sent (- item-sent-amt)
    mod-inventory item-received item-received-amt
  ]
  ask receiver [
    mod-inventory item-sent item-sent-amt
    mod-inventory item-received (- item-received-amt)
